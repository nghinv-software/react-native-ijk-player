...
const IJKPlayerModule = _reactNative.NativeModules.IJKPlayerModule;
const IJKPlayerComponent = (0, _reactNative.requireNativeComponent)('RCTIJKPlayer');

class IJKPlayer extends _react.Component {
  constructor(...args) {
    super(...args);

    _defineProperty(this, "ijkPlayerRef", /*#__PURE__*/_react.default.createRef());
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(IJKPlayerComponent // @ts-ignore
    , _extends({
